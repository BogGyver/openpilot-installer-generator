...
list($notused, $username, $branch, $loading_msg) = explode("/", $url);  # todo: clip these strings at the max length in index (to show up on the webpage)
...
if ($username == "") {
    ...
    echo "<h2><a href='" . BASE_DIR . "/boggyver/tesla_unity_beta'><span>" . WEBSITE_URL . BASE_DIR . "/username/branch</span></a></h2>";
